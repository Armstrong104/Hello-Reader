...
<html lang="en">
  ...
  <body>
	...
	<div id="sidebar">
		<ul>
			<li><a href="Admin_AddItem.php"  target="blank">ADD</li>
			<li><a href="Admin_DeleteItem.php" target="blank">Delete</li>
			<li><a href="Admin_UpdateItem.php" target="blank">Update</li>
		</ul>
	</div>
